    ...
    <aside className="userinfo">
      ...
      {user.username == undefined ? (
        <PlaceholderRectangle
          ...
          height="32px"
          marginTop="20px"
          color="#AAAAAA"></PlaceholderRectangle>
      ) : (
        <div className="user-info-cover">
          ...
          {user.verified && (
            <img
              id="verified"
              alt="verified"
              src={ROOT_IMG_URL + "images/verified.png"}></img>
          )}
          {user.membership > 0 && (
      ...
      <section className="social">
        ...
        {user.username == undefined ? (
          ...
          <div className="friends-cover">
            {Object.keys(user.friends) // Show online friends first
              .filter((friendId) => user.friends[friendId].online == true)
              .map((id) => (
                <div
            ...
            {Object.keys(user.friends) // Show offline friends
              .filter((friendId) => user.friends[friendId].online != true)
              .map((id) => (
                <div
                  className="friends-userbar"
      ...
      <section className="schedule">
        ...
        {recentScheduleLength > 0 ? (
          ...
          <div>{user.success && <p>You haven't studied anything yet.</p>}</div>
        )}
