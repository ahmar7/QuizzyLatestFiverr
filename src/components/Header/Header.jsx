      ...
      {![
        ...
        location.pathname.indexOf("/support") == -1 && (
          <header
            className={
              "header" +
              (location.pathname.indexOf("/upgrade") != -1
                ? " header-upgrade"
                : "")
            }
            id="header"
            style={
              ...
              location.pathname === "/"
                ...
                : {}
              // : location.pathname.includes("/upgrade") ? { display: "none"} : {}
            }>
            <div className="nav-icon" id="nav-icon-header">
              ...
              <h1 className="pc-only quizzy-logo">
                {"Quizzy" + (user.membership > 0 ? "+" : "")}{" "}
              </h1>
              <h1 className="mobile-only quizzy-logo">
                {"Q" + (user.membership > 0 ? "+" : "")}
              </h1>
            </div>
            ...
            <div id="navigation">
              ...
              {location.pathname.includes("/upgrade") && (
                <Link
                  ...
                  to="/support">
                  <h2>
                    Support <div id="selection-dash"></div>
                  </h2>
                </Link>
              )}
              {!location.pathname.includes("/upgrade") && (
            ...
            <div
              onClick={navToggle}
              className={navmbl ? "mbl-overlay " : "mbl-overlay hide-it"}></div>
            ...
            <div className={navLoading ? "right" : "hide-it"} id="right">
              {!location.pathname.includes("/upgrade") && <SearchBar />}
