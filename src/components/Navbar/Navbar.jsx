...
import { get_session_token } from "../../network/communication";
      ...
      <nav>
        <ul>
          <li className="close-nav">
            ...
            }} src="/images/general/threelines.svg" alt="" />
          </li>
          {user.username == undefined ? ( 
            <li>
              <PlaceholderRectangle className="dashboard-label" width="100%" height="3.25rem" color="#CFCFCF" />
            </li>
            
          ) : (
            <li className={props.active == 0 && "active"}>
              <Link to="/dashboard">
                <svg
                  ...
                  >
                    <g id="Group_3" data-name="Group 3">
                      <path
                        ...
                        fill={props.active == 0 ? "#8358e8" : "#7b7b7b"}
                      />
                    </g>
                  </g>
                </svg>
            ...
            <Link to="/dashboard/study">
              ...
              >
                ...
                <path
                  ...
                  fill={props.active == 1 ? "#8358e8" : "#7b7b7b"}
                />
              </svg>
              <h3>Study</h3>
            </Link>
            ...
            <Link to="/dashboard/friends">
              ...
              >
                ...
                <path
                  ...
                  transform="translate(0 0)"
                  fill={props.active == 2 ? "#8358e8" : "#7b7b7b"}
                />
              </svg>
              <h3>Friends</h3>
            </Link>
          ...
          <li className={props.active == 3 && "active"}> 
            <a href={"https://quizzynow.com/php/payments/enter_customer_portal.php?auth_cookie=" + get_session_token()}>
              <svg
              ...
              >
                ...
                <path
                  ...
                  transform="translate(0 0)"
                  fill={props.active == 3 ? "#8358e8" : "#7b7b7b"}
                />
              </svg>
              <h3>Payments</h3>
            </a>
            ...
            <Link to="/dashboard/changelog">
              ...
              >
                ...
                <path
                  ...
                  fill={props.active == 4 ? "#8358e8" : "#7b7b7b"}
                />
              </svg>
            ...
            <Link to="/dashboard/settings/profile">
              ...
              >
                ...
                <path
                  ...
                  fill={props.active == 5 ? "#8358e8" : "#7b7b7b"}
                />
              </svg>
                  ...
                  <g id="Group_7" data-name="Group 7" transform="translate(3 3)">
                    <g id="Group_6" data-name="Group 6">
                      <circle
                        ...
                        fill={props.active == 6 ? "#8358e8" : "#7b7b7b"}
                      />
                      <path
                        id="Path_17"
                        data-name="Path 17"
