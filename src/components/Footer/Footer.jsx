...
function Footer(props) {
    ...
    return (
        <>
            {(!["/signup", "/login", "/404", "/forgot-password", "/reset-password", "/dashboard", "/dashboard/study", "/dashboard/friends", "/dashboard/settings", "/dashboard/settings/profile", "/dashboard/settings/privacy","/dashboard/settings/notifications"].includes(location.pathname) && location.pathname.indexOf("/recall") === -1) && (
