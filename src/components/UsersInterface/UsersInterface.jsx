...
function UsersInterface(props) {
  ...
  return (
    <div className="users-cover">
      <>
        {Object.keys(users) // Show online users first
          .filter((userId) => users[userId].online == true)
          .map((k) => (
            <div
              className="user-info"
              onClick={() => {
              ...
              <div className="content">
                ...
                <div className="userinfo-cover">
                  <div className="user-info-cover">
                    ...
                    {users[k].verified && (
                      <img id="verified" src={CHECKMARK_ICON}></img>
                    )}
        ...
        {/* Show offline users */}
        {Object.keys(users) // Show online friends first
          .filter((userId) => users[userId].online != true)
          .map((k) => (
            <div
              className="user-info"
