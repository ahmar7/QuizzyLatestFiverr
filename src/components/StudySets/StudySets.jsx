        ...
        <div className="studyset">
          <div className="contents">
            ...
            <div className="set-data">
              ...
              <a className="set-info">
                Terms: <strong>{sets[k]?.terms?.length}</strong>
              </a>
            ...
            <div className="creator-data">
              ...
              <div className="creator-info">
                <img
                  ...
                  src={sets[k]?.creator?.avatar_url}></img>
                <a
                  className="creator-username"
                  onClick={() => {
                    navigate("../users/" + sets[k].creator.userid);
                  }}>
                  {sets[k].creator?.username}
                </a>
                {sets[k]?.creator?.verified && (
                  <img
                    src={CHECKMARK_ICON}
                ...
                {sets[k]?.creator?.membership > 0 && (
                  <div className="plus-icon">
                    <a className="plus-icon" href="../quizzyplus/">
                      PLUS
                    </a>
                  </div>
                )}
              ...
              {props.show_mastery && (
                <div className="mastery-progress">
                  ...
                  <div className="mbar">
                    <a className="mastery-label">
                      {sets[k]?.psd?.mastery_progress + "%"}
                    </a>
                    <div className="mastery-bar">
                      <div
                        className="fill"
                        style={{
                          width: sets[k]?.psd?.mastery_progress + "%",
                        }}></div>
                    </div>
                  </div>
                </div>
                ...
                onClick={() => {
                  navigate(
                    "../study/" +
                      sets[k]?.id +
                      "/" +
                      sets[k]?.title?.replace(/\s+/g, "-").toLowerCase()
                  );
                }}>
                <a>Study</a>
              </div>
