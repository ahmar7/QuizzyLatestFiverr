...
import WriteSupportArticle from "./pages/WriteSupportArticle/WriteSupportArticle";
...
const RecallResults = lazy(() => import("./pages/RecallResults/RecallResults"));
        ...
        <Router>
          <Suspense fallback={<LoadingPage />}>
            ...
            <Routes>
              ...
              />
              <Route
                path="/study/:setid/:title/recall/results"
                element={<RecallResults user={user} setUser={setUser} />}
              />
              <Route
