...
function Index(props) {
  ...
  const STUDENT_REFERENCES = [
    [
      ...
      "I wish I had Quizzy when I took German.",
      "Studying AP Biology",
    ],
    [
      "David",
  ...
  return (
    <>
      <div className="thumbnailw">
        <img src="https://quizzynow.com/public/images/Screenshot.png" alt="" />
      </div>
      <main className="index-main">
        <Helmet>
          ...
          <meta
            name="og:image"
            property="og:image"
            content="https://quizzynow.com/public/Untitled-1.png"
          />
          <meta
            name="og:url"
            property="og:url"
            content="https://quizzynow.com/"
          />
        </Helmet>
          ...
          <section className="learning-at-glance" id="learning">
            <div className="info">
              ...
              <p>
                ...
                <br></br>
                <br></br>
                With Quizzy's Study Time Distribution and Mastery Progress
                charts, you'll easily be able to determine if you're prepared or
                not.
              </p>
              <button
                onClick={() => {
          ...
          <section className="meet-recall-sessions">
            ...
            <div className="info">
              ...
              <p>
                ...
                <br></br>
                <br></br>
                Quizzy will give you a term, and ask you to define it. From
                there, just click a smiley face representing how well you know
                the term, and Quizzy will figure out the rest.
              </p>
              <button
                onClick={() => {
                  navigate("/signup");
          ...
          <section className="watch-your-grades">
            <div className="info prob">
              ...
              <p>
                ...
                enter the date of your test, and Quizzy will automatically
                notify you when you need to study.
                <br></br>
                <br></br>
                Recall Sessions typically don't take longer than 5 minutes.
                Getting that A is as simple as telling Quizzy your test date,
                and attending the automatically scheduled Recall Sessions.
              </p>
              <button
                onClick={() => {
                  navigate("/signup");
