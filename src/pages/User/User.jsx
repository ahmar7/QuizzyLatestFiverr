          ...
          {user.image ? (
            <div className="avatar-wrap">
              ...
              <a
                ...
                id={user.role == "Administrator" ? "flicker-text" : ""}>
                {user.role}
              </a>
            </div>
          ) : (
          ...
          <div className="user-info">
            ...
            {user.username == undefined ? (
              ...
              <div className="user-info-cover">
                ...
                {user.verified && (
                  <img id="verified" src="../images/user/check.svg"></img>
                )}
                {user.membership > 0 && (
            ...
            {editingDescription && me.userid == user.userid ? (
              ...
              user != undefined && (
                <a className="description">
                  {user.description}
                  {user != undefined && me.userid == user.userid && (
                    <img
            ...
            {user.username != undefined && me.userid != user.userid && (
              <div className="actions">
                <div
                  className={
                    (user.friends_with_me || user.friend_requested
                      ? "pending "
                      : "") + "button add-friend"
                  }
                  ref={addFriendRef}
        ...
        <div className="bottom-info">
          {user.username != undefined ? (
            <div className="favorite-subjects">
              ...
              <Tags
                tags={favoriteSubjects}
                setTags={setFavoriteSubjects}
                readonly={me.userid !== user.userid}
                max={15}
                onModified={function (tags) {
          ...
          minUserFriends != undefined ? (
            <div className="friends">
              <h1>
                {user.name + "'s Friends - " + Object.keys(user.friends).length}
              </h1>
              <UsersInterface
                users={minUserFriends ? minUserFriends : {}}></UsersInterface>
              {Object.keys(user.sets).length >= MAX_ALLOWED_FRIENDS_ON_PAGE && (
                <div
                  className="more-cover"
                  onClick={() => {
                    navigate("./friends");
                  }}>
                  <h1 className="more">
          ...
          {user.sets !== undefined && (
            <div className="sets">
              <h1>
                {user.name + "'s Sets - " + Object.keys(user.sets).length}
              </h1>
                                ...
                                <table>
                                    ...
                                    {displayDates.map((date, index) => (  
                                        ...
                                        {newRowIndex.includes(index) && (
                                            ...
                                            cellpadding="0"
                                            className={
                                                ((todayIndex <= newRowIndex[newRowIndex.indexOf(index)] && newRowIndex[newRowIndex.indexOf(index)]) < todayIndex + 7) ? "current" : null
                                            }
                                            >
