      ...
      response.json().then(function (data) {
        ...
        if (data["success"] == true) {
          localStorage.setItem(
            "session_token",
            data["userdata"]["session_token"]
          );
          const now = new Date();

          const cookies = new Cookies();
          cookies.set(SECURITY_COOKIE, data["userdata"]["session_token"], {
            path: "/",
          });
          loggedIn = true;
          ...
          setInfoText(
            "Invalid username or password. Check your username or password and try again."
          );
          setShake(1);
          setTimeout(() => {
            setShake(0);
  ...
  return (
    <div className="login" id="login" shake={shake}>
      ...
      <FloatingPopup
        icon="alert"
        title="Error!"
        enabled={invalidPassword}
        setEnabled={setInvalidPassword}
        content="You've entered an invalid username or password!"></FloatingPopup>
      <main className="login-main">
        <Helmet>
          <meta name="description" content={"Login to Quizzy"} />;
          <meta property="og:description" content={"Login to Quizzy"} />
          <meta property="og:title" content={"Quizzy - Login"} />
