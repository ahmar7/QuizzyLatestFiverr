...
function Dashboard(props) {
  ...
  const [alertPopupEnabled, setAlertPopupEnabled] = useState(true);
  ...
  useEffect(() => {
    calculateCalendar();
    fetch("https://quizzynow.com/php/fetch_system_message.php", {
      method: 'GET',
    ...
    <main className="dashboard-main">
      ...
      <section className="dashboard">
        <div className="content">
          ...
          {console.log(alert)}
          {user.success && alert && 
            <FloatingPopup title="Welcome!" content={alert} icon="info" relativePosition={true} enabled={alertPopupEnabled} setEnabled={setAlertPopupEnabled} />
                                ...
                                <tr
                                  ...
                                  className={
                                    ...
                                    todayIndex >
                                      ...
                                      ? "current"
                                      : null
                                    //< newRowIndex[newRowIndex.indexOf(index)] && todayIndex < newRowIndex[newRowIndex.indexOf(index) + 1] ? "current" : null
                                  }
                                >
