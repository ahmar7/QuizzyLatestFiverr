...
export function fetch_transaction(transaction_id, fn) {
  fetch(
    "https://quizzynow.com/php/payments/fetch_transaction.php?transaction_id=" +
      transaction_id +
      "&auth_cookie=" +
      get_session_token(),
    {
...
export function switch_membership(new_plan_id, fn) {
  fetch(
    "https://quizzynow.com/php/payments/upgrade_subscription.php?new_plan_id=" +
      new_plan_id +
      "&auth_cookie=" +
      get_session_token(),
    {
...
export function fetch_article(section, id, fn) {
  fetch(
    "https://quizzynow.com/php/fetch_article.php?section=" +
      section +
      "&id=" +
      id,
    {
...
export function get_recall_info(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_recall_info.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
...
export function get_recall_intervals(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_recall_interval.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
...
export function submit_recall_choice(setid, choice, response, fn) {
  var formData = new FormData();
  formData.append("auth_cookie", get_session_token());
...
export function get_recall_queue(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_recall_queue.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
...
export function get_recall_results(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_recall_results.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
...
export function get_memory_curve(setid, term_index, fn) {
  fetch(
    "https://quizzynow.com/php/get_memory_curve.php?setid=" +
      setid +
      "&term_index=" +
      term_index +
      "&session_token=" +
...
export function get_attempt_distribution(setid, filter = "", term_index, fn) {
  fetch(
    "https://quizzynow.com/php/get_attempt_distribution.php?setid=" +
      setid +
      "&filter=" +
      filter +
      "&term_index=" +
...
export function get_quiz_info(setid, fn) {
  // should return the latest quiz
  fetch(
    "https://quizzynow.com/php/get_quiz_info.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
    ...
    try {
      ...
      fn({ error: "An error occurred", errorText: e });
    }
  });
}
...
export function get_quiz_details(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_quiz_details.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token(),
    {
...
export function get_friends_most_difficult_terms(setid, fn) {
  fetch(
    "https://quizzynow.com/php/get_friends_most_difficult_terms.php?setid=" +
      setid +
      "&request_cookie=" +
      get_session_token(),
    {
...
export function fetch_quiz_info(setid, assoc_id, fn) {
  fetch(
    "https://quizzynow.com/php/fetch_quiz_info.php?setid=" +
      setid +
      "&session_token=" +
      get_session_token() +
      "&assoc_id=" +
...
export function get_drafts(fn) {
  fetch(
    "https://quizzynow.com/php/get_drafts.php?session_token=" +
      get_session_token(),
    {
      method: "GET",
    }
...
export function create_practice_exam(
  setid,
  audio,
  answer_with,
  types_of_questions,
...
export function overwrite_quiz_answers(setid, quizQueue, fn) {
  ...
  for (
    var section_index = 0;
    section_index < quizQueue.length;
    section_index++
  ) {
    //i represents the index of the section
    for (
      var question_index = 0;
      question_index < quizQueue[section_index].length;
      question_index++
    ) {
      ...
      if (
        ans != undefined &&
        ans != null &&
        (Array.isArray(ans) || typeof ans === "object")
      ) {
        // matching
...
export function view_user_info(userid, fn) {
  fetch(
    "https://quizzynow.com/php/get-user-info.php?userid=" +
      userid +
      "&token=" +
      get_session_token(),
    {
...
export function get_article_suggestions(query, fn) {
  fetch(
    "https://quizzynow.com/php/get_article_suggestions.php?query=" + query,
    {
      method: "GET",
    }
  ).then(function (response) {
...
export function search(query, fn, urlSearchParams) {
  ...
  fetch(
    "https://quizzynow.com/php/search.php?query=" +
      query +
      "&token=" +
      get_session_token() +
      "&" +
...
export function reset_password(session, new_password = "", fn) {
  return fetch(
    "https://quizzynow.com/php/reset_password.php?session=" +
      session +
      "&new_password=" +
      new_password,
    {
...
export function get_dashboard_data(fn) {
  return fetch(
    "https://quizzynow.com/php/get_dashboard_data.php?session_token=" +
      get_session_token(),
    {
      method: "GET",
    }
...
export function update_schedule(fn) {
  fetch(
    "https://quizzynow.com/php/update_schedule.php?token=" +
      get_session_token(),
    {
      method: "GET",
    }
...
export function get_set_data(setid, token, fn, category = "flashcards") {
  fetch(
    "https://quizzynow.com/php/view_study_set.php?setid=" +
      setid +
      "&request_cookie=" +
      token +
      "&category=" +
...
export function on_set_closed(setid, studyMethod, token, fn) {
  ...
  fetch(
    "https://quizzynow.com/php/close_study_set.php?setid=" +
      setid +
      "&request_cookie=" +
      token +
      "&study_method=" +
...
export function create_draft(
  ...
  return fetch("https://quizzynow.com/php/create_draft.php", {
    method: "POST",
    body: formData,
    //credentials: "include"
  });
...
export function edit_set(
  ...
  terms.forEach(function (element, index) {
    if (element[2]) {
      td[index][2] = element[2].replace(
        "https://quizzynow.com/uploads/card_images/",
        ""
      );
    }
    if (element[3]) {
      td[index][3] = element[3].replace(
        "https://quizzynow.com/uploads/card_images/",
        ""
      );
    }
...
export function create_set_from_combine(
  title,
  description,
  visibility,
  copy_perms,
